...
{
    class AutoRagdollBuilder : ScriptableWizard
    {
        ...
        protected override bool DrawWizardGUI()
        {
            ...
            if (animator && animator.gameObject.scene.isLoaded)
                GUI.enabled = true;
            else
                GUI.enabled = false;
        ...
        [MenuItem("GameObject/3D Object/Auto Ragdoll...", false, 2001)]
        static void CreateWizard()
        {
            ScriptableWizard.DisplayWizard<AutoRagdollBuilder>("Create Ragdoll");
        }
